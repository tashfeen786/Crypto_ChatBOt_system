...
class Settings(BaseSettings):
    ...
    # ⬇️ FIXED: Secret key should be string
    SECRET_KEY: str = Field(default="d9f8a2b7c4e6f1g3h5j7k8l9m1n3p7q9")
    ...
    DATABASE_URL: str = Field(
        default="postgresql://postgres:0000@localhost:5432/crypto_rag"
    )
