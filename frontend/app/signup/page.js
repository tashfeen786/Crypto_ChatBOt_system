            ...
            {step === 1 && (
              <div className="space-y-4">
                ...
                <button
                  type="button"
                  onClick={nextStep}
                  className="w-full py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl font-bold hover:shadow-2xl hover:shadow-purple-500/50 transition-all hover:scale-105"
                >
                  Next Step →
                </button>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    type="button"
                    onClick={nextStep}
                    className="flex-1 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl font-bold hover:shadow-2xl hover:shadow-purple-500/50 transition-all"
                  >
                    Next →
                  </button>
                </div>
